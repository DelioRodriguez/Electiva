...
class Program
{
    static void Main(string[] args)
    {
        ...
        var northwindConnectionString =
            "Server=(localdb)\\DelioServer;Database=norwind;Trusted_Connection=True;MultipleActiveResultSets=True;";
        var dataWarehouseConnectionString =
            "Server=(localdb)\\DelioServer;Database=DWHNorthWindOrders;Trusted_Connection=True;MultipleActiveResultSets=True;";
